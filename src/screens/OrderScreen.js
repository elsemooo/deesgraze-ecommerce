...
const OrderScreen = ({ match }) => {
  ...
  useEffect(() => {
    const addPayPalScript = async () => {
      const { data: clientId } = await axios.get("https://deesgraze.herokuapp.com/api/config/paypal");
              ...
              <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
                <div className="row">
                  ...
                  <div className="col-md-8 center">
                    ...
                    <p>
                      Direccion: {order.shippingAddress.provincia},{" "}
